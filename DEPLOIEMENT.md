...
## Ajouter l’heure du coup d’envoi

Exécute une seule fois `supabase-migration-match-kickoff-time.sql` dans Supabase > SQL Editor. Cette migration ajoute une heure facultative aux matchs programmés. Elle ne modifie aucune rencontre existante et l’heure reste masquée dès qu’un match est terminé.
